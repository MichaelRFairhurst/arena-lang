...
TypeTable TypeTable::builtin_type_table(const TypeSymbolRegistry &registry) {
    std::unordered_map<std::string_view, ProgramType> builtin_types = {
        {"bool", IntegralType{true, 1, "bool", IntegralLiteralKind::Bool}},
        {"char", IntegralType{true, 1, "char", IntegralLiteralKind::Char}},
        {"byte", IntegralType{false, 1, "byte", IntegralLiteralKind::Int}},
        {"short", IntegralType{true, 2, "short", IntegralLiteralKind::Int}},
        {"ushort", IntegralType{false, 2, "ushort", IntegralLiteralKind::Int}},
        {"int", IntegralType{true, 4, "int", IntegralLiteralKind::Int}},
        {"uint", IntegralType{false, 4, "uint", IntegralLiteralKind::Int}},
        {"long", IntegralType{true, 8, "long", IntegralLiteralKind::Int}},
        {"ulong", IntegralType{false, 8, "ulong", IntegralLiteralKind::Int}},
        {"usize", IntegralType{false, 8, "usize", IntegralLiteralKind::Int}},
        {"ssize", IntegralType{true, 8, "ssize", IntegralLiteralKind::Int}},
